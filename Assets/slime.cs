...
{
    public EnemyTypeslime enemyType = EnemyTypeslime.Enemy1;
    ...
    void setEmemyState(int newState)
    {
        ...
        switch (state)
        {
            ...
            case EMEMY_CHASE:
                ...
                this.transform.LookAt(playerslime.transform);
                break;
            case EMEMY_ATTACK:
                animName = "Attack";
    ...
    {
        //判断敌人与主角之间的距离
        float distance = Vector3.Distance(playerslime.transform.position, this.transform.position);
